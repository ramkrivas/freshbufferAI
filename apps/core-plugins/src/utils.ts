...
export const FRESHBUFFERAI_CHATID = 'freshbufferai_chatId'
...
const jsonEscapeCharacters = [
    { escape: '"', value: 'FRESHBUFFERAI_DOUBLE_QUOTE' },
    { escape: '\n', value: 'FRESHBUFFERAI_NEWLINE' },
    { escape: '\b', value: 'FRESHBUFFERAI_BACKSPACE' },
    { escape: '\f', value: 'FRESHBUFFERAI_FORM_FEED' },
    { escape: '\r', value: 'FRESHBUFFERAI_CARRIAGE_RETURN' },
    { escape: '\t', value: 'FRESHBUFFERAI_TAB' },
    { escape: '\\', value: 'FRESHBUFFERAI_BACKSLASH' }
]
