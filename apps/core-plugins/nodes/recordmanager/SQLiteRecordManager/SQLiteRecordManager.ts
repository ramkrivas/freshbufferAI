...
class SQLiteRecordManager_RecordManager implements INode {
    ...
    constructor() {
        ...
        this.inputs = [
            /*{
                ...
                type: 'string',
                placeholder: 'C:\\Users\\User\\.freshbufferai\\database.sqlite'
            },*/
            {
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const database = path.join(process.env.DATABASE_PATH ?? path.join(getUserHome(), '.freshbufferai'), 'database.sqlite')
