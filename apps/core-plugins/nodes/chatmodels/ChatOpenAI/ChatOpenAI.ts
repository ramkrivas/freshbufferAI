...
import { ChatOpenAI } from './FreshbufferAIChatOpenAI'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description:
                    'Allow image input. Refer to the <a href="https://docs.freshbufferai.com/using-freshbufferai/uploads#image" target="_blank">docs</a> for more details.',
                default: false,
                optional: true
            },
            {
